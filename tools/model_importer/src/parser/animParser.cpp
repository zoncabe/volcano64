...
namespace
{
  V64M::AnimChannelTarget getTarget(cgltf_animation_path_type type) {
    switch(type) {
      case cgltf_animation_path_type_translation: return V64M::AnimChannelTarget::TRANSLATION;
      case cgltf_animation_path_type_rotation   : return V64M::AnimChannelTarget::ROTATION;
      case cgltf_animation_path_type_scale      : return V64M::AnimChannelTarget::SCALE;
      default:
  ...
  void insertScalarKeyframe(V64M::Anim &anim, float time, uint32_t chIdx, Vec3 value, bool isTranslate, float globalScale) {
